...
int main(){
    ...
    vector<string> questions = { "What were the views of Mahatma Gandhi on the Partition of India?",
                                "Who was Mahatma Gandhi?",
                                "What were Gandhi's views on the manner of how one should eat?",
                                "What is the purpose of life?",
                                "What was the effect of tea and coffee according to Mahatma?","What were gandhi's views on  satyagraha?"};
    ...
    */
    ...
    //     vector<string> paras;
    //     while(head != nullptr){
    //         cout<<"Book: "<<head->book_code<<" Page: "<<head->page<<" Paragraph: "<<head->paragraph<<endl;
